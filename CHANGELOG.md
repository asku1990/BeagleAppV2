...
- Näyttelyiden workbook-preview käyttää nyt tiukkaa workbook-kattavuusvalidointia: jokainen ei-tyhjä Kennelliitto-workbookin sarake pitää pystyä tuomaan oikeaan pysyvään kohteeseen kanonisessa näyttelymallissa. Tuntemattomat lisäsarakkeet, `Rotukoodi`-kaltaiset ilman tietokantakohdetta jäävät sarakkeet, duplikaattiheaderit ja nimeämättömät dataa sisältävät sarakkeet estävät validoinnin hiljaisen ohituksen sijaan.

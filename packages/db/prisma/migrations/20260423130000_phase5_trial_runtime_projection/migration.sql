...
COMMENT ON COLUMN "TrialEra"."yva" IS 'General impression points for the era.';
COMMENT ON COLUMN "TrialEra"."hlo" IS 'Search looseness points/penalty value for the era.';
COMMENT ON COLUMN "TrialEra"."alo" IS 'Driving-skill or driving looseness value for the era.';

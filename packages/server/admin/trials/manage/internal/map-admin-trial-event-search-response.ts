...
export function mapAdminTrialEventSearchResponse(
  ...
  return {
    ...
    items: result.items.map((item) => ({
      ...
      ylituomari: item.ylituomari,
      ylituomariNumero: item.ylituomariNumero,
      ytKertomus: item.ytKertomus,
      kennelpiiri: item.kennelpiiri,
      kennelpiirinro: item.kennelpiirinro,

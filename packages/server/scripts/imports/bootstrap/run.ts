...
async function main() {
  ...
  console.log(
    "[import:bootstrap] Starting bootstrap-admin -> seed-show-result-definitions -> seed-show-workbook-import-schema -> phase1 -> phase1.25 -> phase1.5 -> phase2 -> phase3 -> phase5",
  );
  ...
  runPhase("../phase1_25/run.ts", "import:phase1.25", args);

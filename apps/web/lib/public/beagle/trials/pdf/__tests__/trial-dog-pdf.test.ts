...
describe("renderTrialDogPdf", () => {
  ...
  it.each([
    ["trw_pre_20020801", "ajok-koirakohtainen-poytakirja.pdf"],
    ["trw_range_2002_2005", "ajok-koirakohtainen-poytakirja.pdf"],
    ["trw_range_2005_2011", "ajok-koirakohtainen-poytakirja-2005-2011.pdf"],
    ["trw_post_20110801", "ajok-koirakohtainen-poytakirja.pdf"],
    ["trw_post_20230801", "ajok-koirakohtainen-poytakirja.pdf"],
    [null, "ajok-koirakohtainen-poytakirja.pdf"],
    ["unknown-window", "ajok-koirakohtainen-poytakirja.pdf"],
  ])(
  ...
  it("does not fall back to another timeline for unknown rule windows", async () => {
    ...
    expect(rawPdf).not.toContain("SHOULD-NOT-RENDER-UNKNOWN");
    expect(rawPdf).not.toContain("SHOULD-NOT-RENDER-DOG");
  });
});

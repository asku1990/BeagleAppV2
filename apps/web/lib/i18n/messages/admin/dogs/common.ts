export const fiAdminDogsCommonMessages = {
  ...
  "admin.dogs.filters.advanced.close": "Piilota tarkennetut suodattimet",
  "admin.dogs.filters.advanced.title": "Tarkennetut suodattimet",
  "admin.dogs.filters.statusLabel": "Koiran tyyppi",
  "admin.dogs.filters.status.all": "Kaikki koirat",
  "admin.dogs.filters.sexAria": "Suodata koirat sukupuolen mukaan",
  "admin.dogs.filters.sex.all": "Kaikki",
  "admin.dogs.status.normal": "Normaali koira",
  "admin.dogs.status.referenceOnly": "Sukutaulukoira",
...
export const svAdminDogsCommonMessages = {
  ...
  "admin.dogs.filters.advanced.close": "Dölj avancerade filter",
  "admin.dogs.filters.advanced.title": "Avancerade filter",
  "admin.dogs.filters.statusLabel": "Hundtyp",
  "admin.dogs.filters.status.all": "Alla hundar",
  "admin.dogs.filters.sexAria": "Filtrera hundar efter kon",
  "admin.dogs.filters.sex.all": "Alla",
  "admin.dogs.status.normal": "Normal hund",
  "admin.dogs.status.referenceOnly": "Referenshund",

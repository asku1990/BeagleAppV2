export const fiSearchMessages = {
  ...
  "search.form.sort.ekAsc": "EK-numero (pienin ensin)",
  "search.form.sort.nameAsc": "Nimi (A-Ö)",
  "search.advanced.sex": "Sukupuoli",
  "search.advanced.sex.male": "Uros (U)",
  "search.advanced.sex.female": "Narttu (N)",
  ...
  "search.advanced.multipleRegsOnly":
    "Vain koirat, joilla on useita rekisterinumeroita",
  "search.advanced.option.any": "Kaikki",
  "search.results.title": "Hakutulokset",
  "search.results.count": "Osumia:",
  "search.results.col.ek": "EK-numero",
  "search.results.col.reg": "Rekisterinumero",
  "search.results.col.regAll": "Muut rekisterinumerot",
  "search.results.col.sex": "Sukupuoli",
  "search.results.col.name": "Nimi",
  "search.results.col.trialsShows": "Ko/ Nä",
  "search.results.col.trials": "Kokeet (lkm)",
  "search.results.col.shows": "Näyttelyt (lkm)",
  "search.results.col.actions": "Lisätiedot",
  "search.results.parents.sire": "Isä",
  "search.results.parents.dam": "Emä",
  "search.results.sex.male": "Uros",
  "search.results.sex.female": "Narttu",
...
export const svSearchMessages = {
  ...
  "search.form.sort.ekAsc": "SSB-nummer (lägsta först)",
  "search.form.sort.nameAsc": "Namn (A-Ö)",
  "search.advanced.sex": "Kön",
  "search.advanced.sex.male": "Hane (H)",
  "search.advanced.sex.female": "Tik (T)",
  ...
  "search.advanced.multipleRegsOnly":
    "Endast hundar med flera registreringsnummer",
  "search.advanced.option.any": "Alla",
  "search.results.title": "Sökresultat",
  "search.results.count": "Träffar:",
  "search.results.col.ek": "SSB-nummer",
  "search.results.col.reg": "Registreringsnummer",
  "search.results.col.regAll": "Övriga registreringsnummer",
  "search.results.col.sex": "Kön",
  "search.results.col.name": "Namn",
  "search.results.col.trialsShows": "Ja/ Ut",
  "search.results.col.trials": "Jaktprov (antal)",
  "search.results.col.shows": "Utställningar (antal)",
  "search.results.col.actions": "Övriga uppgifter",
  "search.results.parents.sire": "Far",
  "search.results.parents.dam": "Mor",
  "search.results.sex.male": "Hane",
  "search.results.sex.female": "Tik",

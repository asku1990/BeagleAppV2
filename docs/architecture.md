...
This document is the **canonical source of truth** for code architecture and dependency boundaries in Beagle App v2. The root `ARCHITECTURE.md` is a permanent compatibility pointer that links here.

If another file (such as `AGENTS.md`) contains conflicting guidance, follow this document and note the conflict.
